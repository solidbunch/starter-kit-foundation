...
1. Create a new project directory[^1]:
...
[^1]: We recomend to use `/srv` folder. Create `/srv/apps/` folder for your web apps. See [FHS](https://refspecs.linuxfoundation.org/FHS_3.0/fhs/ch03s17.html).
