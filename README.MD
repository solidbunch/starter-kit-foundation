...
Current docker containers do not have a custom SMTP server. We use SMTP relay service. You can set up an SMTP server like Gmail or AWS, etc, or use another server you like. Just edit ssmtp.conf
