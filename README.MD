...
│   ├── wp-config/            # wp-config.php and files that should be copied to web root dir
...
`wp-core` - web public directory. Do not edit files in the `wp-core` folder, it installs by composer.
